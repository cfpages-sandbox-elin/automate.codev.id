...
export const onRequestPost: PagesFunction<Env> = async (context) => proxyToOracle(context, { path: '/nca/media/convert/mp3', method: 'POST', body: await readJsonBody(context.request) });

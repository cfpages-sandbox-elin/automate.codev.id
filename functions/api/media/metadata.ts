...
export const onRequestPost: PagesFunction<Env> = async (context) => proxyToOracle(context, { path: '/nca/media/metadata', method: 'POST', body: await readJsonBody(context.request) });

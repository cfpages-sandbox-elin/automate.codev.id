...
export const onRequestPost: PagesFunction<Env> = async (context) => proxyToOracle(context, { path: '/nca/video/trim', method: 'POST', body: await readJsonBody(context.request) });

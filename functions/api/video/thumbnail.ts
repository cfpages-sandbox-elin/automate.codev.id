...
export const onRequestPost: PagesFunction<Env> = async (context) => proxyToOracle(context, { path: '/nca/video/thumbnail', method: 'POST', body: await readJsonBody(context.request) });
